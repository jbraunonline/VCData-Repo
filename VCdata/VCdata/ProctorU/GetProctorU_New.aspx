<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GetProctorU_New.aspx.vb" Inherits="VCdata.GetProctorU_New" %>
...
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
   ...
   <telerik:GridTemplateColumn  HeaderText="Iteration Exam URL (Not required)" AllowSorting="false" AllowFiltering="false">
                        <ItemTemplate>
                           ...
                           <telerik:GridBoundColumn DataField="RPassword" FilterControlAltText="Filter LPassword column" HeaderText="Iteration Exam Password" SortExpression="RPassword" UniqueName="RPassword" Visible="true" >
                    </telerik:GridBoundColumn>
   ...
   <telerik:GridTemplateColumn HeaderText="Resources" AllowSorting="false" AllowFiltering="false">
                        <ItemTemplate>
                            <asp:Label ID="Resources" runat="server" Text='<%# getFinalInstructions(Eval("MasterProctor_ID"))%>'></asp:Label>
                        </ItemTemplate>
  </telerik:GridTemplateColumn>
