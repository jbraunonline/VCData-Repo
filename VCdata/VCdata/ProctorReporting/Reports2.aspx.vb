...
Public Class Reports2
    ...
    Protected Sub btnCopy_Click(sender As Object, e As EventArgs) Handles btnCopy.Click
        ...
        If RadioButtonAction.SelectedValue = "Preview" Then
            Response.Write("<br><font color=red>getdata =" & strsql & "</font><br>")
        End If
        ...
        If dr.HasRows Then
            While dr.Read()
                ...
                Response.Write("<font color=blue><br>xxxxxxxxxx <br>" & dr("FamilyString") & "  " & dr("Course") & dr("Instructor") & "  " & CStr(dr("MidStart")) & "  " & CStr(dr("MidEnd")) & "  " & CStr(dr("MidTime")) & "  " & CStr(dr("LockdownMid")) & "  " & "</font><br>")
                ...
                For i = LBound(astrValues) To UBound(astrValues)
                    ...
                    'Response.Write("<font color=blue><br>xxxxxxxxxx <br>" & dr("FamilyString") & "  " & dr("Course") & "-" & astrValues(i) & "  " & dr("Instructor") & "  " & CStr(dr("MidStart")) & "  " & CStr(dr("MidEnd")) & "  " & CStr(dr("MidTime")) & "  " & CStr(dr("LockdownMid")) & "  " & "</font><br>")
    ...
    Protected Sub btnPasswords_Click(sender As Object, e As EventArgs) Handles btnPasswords.Click
        ...
        If (DropDownList1.SelectedValue = "1") And radioExam.SelectedValue = "isMidTerm" Then
            ...
            strsql += "Update dbo.MasterProctorTesting <br>"
            strsql += "set MasterProctorTesting.LPassword = MasterExamDates.Mid1_LPass,  <br>"
            strsql += "MasterProctorTesting.RPassword =MasterExamDates.Mid1_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting.course and MasterProctorTesting.Session = '1' and MasterProctorTesting.ExamType='Mid' <br>"
        End If
        If (DropDownList1.SelectedValue = "1") And radioExam.SelectedValue = "isFinal" Then

            strsql += "Update dbo.MasterProctorTesting <br>"
            strsql += "set MasterProctorTesting.LPassword = MasterExamDates.FInal1_LPass,  <br>"
            strsql += "MasterProctorTesting.RPassword =MasterExamDates.Final1_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting.course and MasterProctorTesting.Session = '1' and MasterProctorTesting.ExamType='Final' <br>"
        End If
        If (DropDownList1.SelectedValue = "8W1") And radioExam.SelectedValue = "isMidTerm" Then

            strsql += "Update dbo.MasterProctorTesting <br>"
            strsql += "set MasterProctorTesting.LPassword = MasterExamDates.MidA_LPass,  <br>"
            strsql += "MasterProctorTesting.RPassword =MasterExamDates.MidA_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting.course and MasterProctorTesting.Session = '8W1' and MasterProctorTesting.ExamType='Mid' <br>"
        End If
        If (DropDownList1.SelectedValue = "8W1") And radioExam.SelectedValue = "isFinal" Then

            strsql += "Update dbo.MasterProctorTesting <br>"
            strsql += "set MasterProctorTesting.LPassword = MasterExamDates.FInalA_LPass,  <br>"
            strsql += "MasterProctorTesting.RPassword =MasterExamDates.FinalA_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting.course and MasterProctorTesting.Session = '8W1' and MasterProctorTesting.ExamType='Final' <br>"
        End If
        If (DropDownList1.SelectedValue = "8W2") And radioExam.SelectedValue = "isMidTerm" Then

            strsql += "Update dbo.MasterProctorTesting <br>"
            strsql += "set MasterProctorTesting.LPassword = MasterExamDates.MidB_LPass,  <br>"
            strsql += "MasterProctorTesting.RPassword =MasterExamDates.MidB_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting.course and MasterProctorTesting.Session = '8W2' and MasterProctorTesting.ExamType='Mid' <br>"
        End If

        If (DropDownList1.SelectedValue = "8W2") And radioExam.SelectedValue = "isFinal" Then

            strsql += "Update dbo.MasterProctorTesting <br>"
            strsql += "set MasterProctorTesting.LPassword = MasterExamDates.FinalB_LPass,  <br>"
            strsql += "MasterProctorTesting.RPassword =MasterExamDates.FinalB_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting.course and MasterProctorTesting.Session = '8W2' and MasterProctorTesting.ExamType='Final' <br>"
        End If
        ...
        If (DropDownList1.SelectedValue = "6W1") And radioExam.SelectedValue = "isMidTerm" Then
            ...
            strsql += "MasterProctorTesting.RPassword =MasterExamDates.MidA_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting.course and MasterProctorTesting.Session = '6W1' and MasterProctorTesting.ExamType='Mid' <br>"
        End If
        If (DropDownList1.SelectedValue = "6W1") And radioExam.SelectedValue = "isFinal" Then
            ...
            strsql += "MasterProctorTesting.RPassword =MasterExamDates.FinalA_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting.course and MasterProctorTesting.Session = '6W1' and MasterProctorTesting.ExamType='Final' <br>"
        End If
        ...
        If (DropDownList1.SelectedValue = "6W2") And radioExam.SelectedValue = "isMidTerm" Then
            ...
            strsql += "MasterProctorTesting.RPassword =MasterExamDates.MidB_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting.course and MasterProctorTesting.Session = '6W2' and MasterProctorTesting.ExamType='Mid' <br>"
        End If
        If (DropDownList1.SelectedValue = "6W2") And radioExam.SelectedValue = "isFinal" Then
            ...
            strsql += "MasterProctorTesting.RPassword =MasterExamDates.FinalB_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting.course and MasterProctorTesting.Session = '6W2' and MasterProctorTesting.ExamType='Final' <br>"
        End If

        Response.Write(strsql & "<br>")

        lblCode.Text = Replace(strsql, "<br>", "")
        Dim PassSql As String = Replace(strsql, "<br>", "")
        ...
        End Try
        Response.Write("Passwords updated for Session " & DropDownList1.SelectedValue & " Exam " & radioExam.SelectedItem.ToString)
    End Sub
End Class