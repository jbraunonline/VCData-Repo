...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server">
            ...
            <br />
            &nbsp;<asp:TextBox ID="txtTerm" runat="server">2205</asp:TextBox>
            <span class="style1"><strong>MDC Term&nbsp; e.g. 2</strong>197</span><br />
            <br />
            <asp:TextBox ID="txtTermYear" runat="server">2020</asp:TextBox>
            ...
            <asp:TextBox ID="txtTermChoiceID" runat="server" 
                ontextchanged="txtTermChoiceID_TextChanged">73</asp:TextBox>
            &nbsp;<span class="style1"><strong>TermChoiceID&nbsp; Fall 2019=71&nbsp; Get curent number from FLVC upload site.2205=73</strong></span><br />&nbsp;<asp:TextBox ID="txtGSFIS" runat="server">15</asp:TextBox>
