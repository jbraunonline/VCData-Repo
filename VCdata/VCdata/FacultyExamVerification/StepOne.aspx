<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StepOne.aspx.vb" Inherits="VCdata.StepOne" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel4" runat="server" Visible="False">
            ...
            <br />
            <asp:Label ID="lblStep2" runat="server" Font-Bold="True" ForeColor="#CC0000" Text="Go to Step2.aspx" Visible="False"></asp:Label>
            <br />
            <br />
            <br />
        </asp:Panel>
