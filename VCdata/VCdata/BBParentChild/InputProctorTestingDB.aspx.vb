...
Public Class InputProctorTestingDB
    ...
    Protected Sub btnPasswords_Click(sender As Object, e As EventArgs) Handles btnPasswords.Click
        ...
        If (DropDownList1.SelectedValue = "1") And radioExam.SelectedValue = "isMidTerm" Then
            ...
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting_BU.course and MasterProctorTesting_BU.Session = '1' and MasterProctorTesting_BU.ExamType='Mid' <br>"
        End If
        If (DropDownList1.SelectedValue = "1") And radioExam.SelectedValue = "isFinal" Then
            ...
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting_BU.course and MasterProctorTesting_BU.Session = '1' and MasterProctorTesting_BU.ExamType='Final' <br>"
        End If
        If (DropDownList1.SelectedValue = "8W1") And radioExam.SelectedValue = "isMidTerm" Then
            ...
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting_BU.course and MasterProctorTesting_BU.Session = '8W1' and MasterProctorTesting_BU.ExamType='Mid' <br>"
        End If
        If (DropDownList1.SelectedValue = "8W1") And radioExam.SelectedValue = "isFinal" Then
            ...
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting_BU.course and MasterProctorTesting_BU.Session = '8W1' and MasterProctorTesting_BU.ExamType='Final' <br>"
        End If
        If (DropDownList1.SelectedValue = "8W2") And radioExam.SelectedValue = "isMidTerm" Then
            ...
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting_BU.course and MasterProctorTesting_BU.Session = '8W2' and MasterProctorTesting_BU.ExamType='Mid' <br>"
        End If
        ...
        If (DropDownList1.SelectedValue = "8W2") And radioExam.SelectedValue = "isFinal" Then
            ...
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting_BU.course and MasterProctorTesting_BU.Session = '8W2' and MasterProctorTesting_BU.ExamType='Final' <br>"
        End If
        ...
        If (DropDownList1.SelectedValue = "6W1") And radioExam.SelectedValue = "isMidTerm" Then
            ...
            strsql += "MasterProctorTesting_BU.RPassword =MasterExamDates.MidA_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting_BU.course and MasterProctorTesting_BU.Session = '6W1' and MasterProctorTesting_BU.ExamType='Mid' <br>"
        End If
        If (DropDownList1.SelectedValue = "6W1") And radioExam.SelectedValue = "isFinal" Then
            ...
            strsql += "MasterProctorTesting_BU.RPassword =MasterExamDates.FinalA_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting_BU.course and MasterProctorTesting_BU.Session = '6W1' and MasterProctorTesting_BU.ExamType='Final' <br>"
        End If
        ...
        If (DropDownList1.SelectedValue = "6W2") And radioExam.SelectedValue = "isMidTerm" Then
            ...
            strsql += "MasterProctorTesting_BU.RPassword =MasterExamDates.MidB_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting_BU.course and MasterProctorTesting_BU.Session = '6W2' and MasterProctorTesting_BU.ExamType='Mid' <br>"
        End If
        If (DropDownList1.SelectedValue = "6W2") And radioExam.SelectedValue = "isFinal" Then
            ...
            strsql += "MasterProctorTesting_BU.RPassword =MasterExamDates.FinalB_RPass  <br>"
            strsql += "From MasterExamDates  <br>"
            strsql += "where MasterExamDates.Term = '" & txtTerm.Text & "' AND MasterExamDates.Course = MasterProctorTesting_BU.course and MasterProctorTesting_BU.Session = '6W2' and MasterProctorTesting_BU.ExamType='Final' <br>"
        End If
