<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Compare.aspx.vb" Inherits="Telerik2.Compare" %>
...
Default Values
        ...
        <table class="auto-style3">
            ...
            <tr>
                <td>
                    <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:VC_VCDataConnectionString %>" SelectCommand="SELECT [IsFinal], [FinalStart], [FinalEnd], [FinalNameL], [FinalNameR], [FinalTime], [FinalPaper], [FinalCalculator], [FinalGraph], [FinalNotes], [InstComments], [FinalProctorX], [LockdownFinal], [PF_ANXMTR] FROM [MasterProctor] WHERE ([ID] = @ID)">
                        <SelectParameters>
                            <asp:QueryStringParameter DefaultValue="1" Name="ID" QueryStringField="ID" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                ...
                <td>
                    <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:VC_VCDataConnectionString %>" SelectCommand="SELECT [IsFinal], [FinalStart], [FinalEnd], [FinalNameL], [FinalTime], [FinalPaper], [FinalCalculator], [FinalGraph], [FinalNotes], [InstComments], [FinalProctorX], [PF_ANXMTR], [FinalNameR], [LockdownFinal] FROM [MasterProctor_BU] WHERE ([ID] = @ID)">
                        <SelectParameters>
                            <asp:QueryStringParameter DefaultValue="1" Name="ID" QueryStringField="ID" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
