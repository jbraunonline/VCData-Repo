Public Class SpecialAttentionFinals
    ...
    Function getPopUp(ByVal myID As Integer) As String
        ...
        myreturn = "<a href='CompareFinal.aspx?ID=" & myID & "' onclick=""centeredPopup(this.href,'myWindow','1450','860','yes');return false"">Details</a>"
