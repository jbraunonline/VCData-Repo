<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CompareFinal.aspx.vb" Inherits="Telerik2.CompareFinal" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <strong>Final Details<asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:VC_VCDataConnectionString %>" DeleteCommand="DELETE FROM [MasterProctor] WHERE [ID] = @ID" InsertCommand="INSERT INTO [MasterProctor] ([Course], [IsFinal], [FinalStart], [FinalEnd], [FinalTime], [FinalPaper], [FinalCalculator], [FinalProctorX], [LockdownFinal], [FinalEssay], [PF_ANXMTR], [FinalVerified]) VALUES (@Course, @IsFinal, @FinalStart, @FinalEnd, @FinalTime, @FinalPaper, @FinalCalculator, @FinalProctorX, @LockdownFinal, @FinalEssay, @PF_ANXMTR, @FinalVerified)" SelectCommand="SELECT [ID], [Course], [IsFinal], [FinalStart], [FinalEnd], [FinalTime], [FinalPaper], [FinalCalculator], [FinalProctorX], [LockdownFinal], [FinalEssay], [PF_ANXMTR], [FinalVerified] FROM [MasterProctor] WHERE ([ID] = @ID)" UpdateCommand="UPDATE [MasterProctor] SET [Course] = @Course, [IsFinal] = @IsFinal, [FinalStart] = @FinalStart, [FinalEnd] = @FinalEnd, [FinalTime] = @FinalTime, [FinalPaper] = @FinalPaper, [FinalCalculator] = @FinalCalculator, [FinalProctorX] = @FinalProctorX, [LockdownFinal] = @LockdownFinal, [FinalEssay] = @FinalEssay, [PF_ANXMTR] = @PF_ANXMTR, [FinalVerified] = @FinalVerified WHERE [ID] = @ID">
                <DeleteParameters>
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateEditColumn="True" DataSourceID="SqlDataSource6" Skin="WebBlue" AllowAutomaticUpdates="True" AutoGenerateColumns="False">
...
<ItemStyle Width="300px"></ItemStyle>
        ...
        <table class="auto-style3">
            ...
            <tr>
                ...
                <td>
                    <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [IsFinal], [FinalStart], [FinalEnd], [FinalNameL], [FinalNameR], [FinalTime], [FinalPaper], [FinalCalculator], [FinalGraph], [FinalNotes], [InstComments], [FinalProctorX], [LockdownFinal], [PF_ANXMTR] FROM [MasterProctor_8w2BU] WHERE ([Parent] = @Parent)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="txtParent" DefaultValue="2203-4493" Name="Parent" PropertyName="Text" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
            </tr>
        ...
        <table class="auto-style1">
            <tr>
                <td>User Input"
                    <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" Height="50px" Width="300px">
                        ...
                        <FieldHeaderStyle BackColor="#DEE8F5" Font-Bold="True" />
                        <Fields>
                            <asp:BoundField DataField="IsMidterm" HeaderText="IsMidterm" SortExpression="IsMidterm" />
                            ...
                            <asp:BoundField DataField="MidPaper" HeaderText="MidPaper" SortExpression="MidPaper" />
                            <asp:BoundField DataField="MidCalculator" HeaderText="MidCalculator" SortExpression="MidCalculator" />
                            <asp:BoundField DataField="MidGraph" HeaderText="MidGraph" SortExpression="MidGraph" />
                            <asp:BoundField DataField="MidNotes" HeaderText="MidNotes" SortExpression="MidNotes" />
                            <asp:BoundField DataField="InstComments" HeaderText="InstComments" SortExpression="InstComments" />
                            <asp:BoundField DataField="MidProctorX" HeaderText="MidProctorX" SortExpression="MidProctorX" />
            ...
            <tr>
                <td class="auto-style2">
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [IsMidterm], [MidStart], [MidEnd], [MidNameL], [MidNameR], [MidTime], [MidPaper], [MidCalculator], [MidGraph], [MidNotes], [InstComments], [MidProctorX], [PM_ANXMTR] FROM [MasterProctor]"></asp:SqlDataSource>
                </td>
                <td class="auto-style2">
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [IsMidterm], [MidStart], [MidEnd], [MidNameL], [MidNameR], [MidTime], [MidPaper], [MidCalculator], [MidGraph], [MidNotes], [InstComments], [MidProctorX], [PM_ANXMTR] FROM [MasterProctor_BU] WHERE ([ID] = @ID)">
                        <SelectParameters>
                            <asp:QueryStringParameter DefaultValue="1" Name="ID" QueryStringField="ID" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
