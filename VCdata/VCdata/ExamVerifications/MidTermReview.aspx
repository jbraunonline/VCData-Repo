<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MidTermReview.aspx.vb" Inherits="VCdata.MidTermReview" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <strong><span class="auto-style4">Verifiction of Mid Term Exam Settings Changed by Faculty</span></strong><br />
...
&nbsp;&nbsp; Term<br />
            ...
            \&nbsp;&nbsp; Session<br />
            <asp:DropDownList ID="ddlExam" runat="server" Visible="False">
                <asp:ListItem Selected="True">Select Exam</asp:ListItem>
                <asp:ListItem>MidTerm</asp:ListItem>
                <asp:ListItem>Final</asp:ListItem>
            </asp:DropDownList>
            <br />
            <asp:Button ID="btnGetData" runat="server" Text="Change Data" BorderColor="#CC0000" />
        </div>
        <p class="auto-style1">
            <strong>Proctor Settings Report for <span class="auto-style3">NOT DEFAULT </span>selection.&nbsp; MID TERM Exams&nbsp;&nbsp;&nbsp;&nbsp; Term =</strong>
            <asp:Label ID="lblSelection" runat="server" Font-Bold="True"></asp:Label>
        </p>
...
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ID], [MidNotes], [FamilyString], [Course], [Instructor], [Outlook], [CanChange], [Session], [InstComments], [MidVerified] FROM [MasterProctor] WHERE (([Term] = @Term) AND ([UseDefault] = @UseDefault) AND ([IsMidterm] = @IsMidterm)) and (Session = @Session)">
            <SelectParameters>
