<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GetSetupM1.aspx.vb" Inherits="VCdata.GetSetupM1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            MidTerm Setup
            <telerik:RadGrid ID="RadGrid1" runat="server" DataSourceID="SqlDataMid1" Skin="WebBlue" OnItemDataBound="RadGrid1_ItemDataBound" AllowSorting="True"   CommandItemDisplay="Top" AutoGenerateColumns="False" AllowFilteringByColumn="True" Width="1800px" >
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
                <ExportSettings OpenInNewWindow="True">
                    <Excel Format="Xlsx" />
                </ExportSettings>
                <MasterTableView DataSourceID="SqlDataMid1"   CommandItemDisplay="Top" >
                    ...
                    <telerik:GridTemplateColumn UniqueName="TemplateColumn" HeaderText="#" AllowFiltering="false">
                        ...
                        <telerik:GridBoundColumn DataField="Session" FilterControlAltText="Filter Session column" HeaderText="Session" SortExpression="Session" UniqueName="Session"  AllowFiltering="false">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="Mid1_RPass" FilterControlAltText="Filter Mid1_RPass column" HeaderText="Mid1_RPass" SortExpression="Mid1_RPass" UniqueName="Mid1_RPass" AllowFiltering="false">
                        </telerik:GridBoundColumn>
   ...
   <telerik:GridTemplateColumn DataField="ID" HeaderText="Proctor Data" AllowSorting="false"   AllowFiltering="false">
                        <ItemTemplate>
                            <asp:Label ID="ProctorData" runat="server" Text='<%#getProctor(Eval("myID"))%>'></asp:Label>
                        </ItemTemplate>
  </telerik:GridTemplateColumn>
