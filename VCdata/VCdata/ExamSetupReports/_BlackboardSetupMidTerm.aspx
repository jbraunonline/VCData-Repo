<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="_BlackboardSetupMidTerm.aspx.vb" Inherits="VCdata.BlackboardSetupMidTerm" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
                  ...
                  <span class="auto-style1"><strong>Blackboard Setup Team&nbsp; <span class="auto-style2">MidTerm Only</span></strong></span><br />
            ...
            <asp:RadioButtonList ID="radioExam" runat="server" RepeatDirection="Horizontal" Visible="False">
                ...
                <asp:ListItem Value="True" Enabled="False">Final</asp:ListItem>
            </asp:RadioButtonList>
...
&nbsp;
        ...
        <asp:Panel ID="Panel2" runat="server">
            ...
            <br />
            <telerik:RadGrid ID="RadGrid1" runat="server" DataSourceID="SqlDataSource1" Skin="WebBlue" OnItemDataBound="RadGrid1_ItemDataBound" AllowSorting="True" CellSpacing="-1" GridLines="Both" >
  ...
  <telerik:GridTemplateColumn HeaderText="LDB" AllowSorting="false" AllowFiltering="false">
                        <ItemTemplate>
                            <asp:Label ID="MidLockdown" runat="server" Text='<%#getLockDownMid(Eval("PM_ANXMTR"), Eval("Essay"))%>'></asp:Label>
                        </ItemTemplate>
  </telerik:GridTemplateColumn>
  ...
  <telerik:GridTemplateColumn HeaderText="Instructions" AllowSorting="false" AllowFiltering="false">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ID], [FamilyString], [Parent], [Course], [Instructor], [Outlook], [Session], [IsMidTerm], [MidStart], [MidEnd], [MidTime], [PM_ANXMTR], [Essay] FROM [MasterProctor] WHERE (([Session] = @Session) AND ([IsMidTerm] = @IsMidTerm) and optin =1) Order By Course">
            <SelectParameters>
