    ...
    Function getProctorMid(ByVal myID As Integer) As String
        ...
        If dr.HasRows Then
            While dr.Read()
                ...
                myreturn = mypaper & mycalc & myGraph & myBlob
        ...
        Return myreturn
    End Function
    Protected Function getLockDownMid(ByVal myANXMTR As String, isEssay As Boolean) As String
        Dim myreturn As String = "True"
        If isEssay = True Then
            myreturn = "False"
        End If

        If myANXMTR.Contains("PDF") OrElse myANXMTR.Contains("Excel") OrElse myANXMTR.Contains("Headphones") OrElse myANXMTR.Contains("Note Pad") Then
            myreturn = "False"
        End If
