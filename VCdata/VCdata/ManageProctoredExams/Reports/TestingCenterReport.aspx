<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TestingCenterReport.aspx.vb" Inherits="VCdata.TestingCenterReport" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#DDF4FF">
            ...
            <asp:DropDownList ID="ddlTerm" runat="server">
                <asp:ListItem>Select Tern</asp:ListItem>
...
<telerik:GridTemplateColumn HeaderText="Session / Exam" AllowSorting="false" AllowFiltering="false">
                        ...
                        <telerik:GridBoundColumn DataField="ExamTime" DataType="System.Int32" FilterControlAltText="Filter ExamTime column" HeaderText="ExamTime" SortExpression="ExamTime" UniqueName="ExamTime">
                           ...
                           <telerik:GridTemplateColumn HeaderText="LPassword" AllowSorting="false" AllowFiltering="false">
                        <ItemTemplate>
                            <asp:Label ID="MyPassLocal" runat="server" Text='<%#GetLocalPass(Eval("Course"))%>'></asp:Label>
                        </ItemTemplate>
  </telerik:GridTemplateColumn>
                           ...
                           <telerik:GridTemplateColumn HeaderText="RPassword" AllowSorting="false" AllowFiltering="false">
                        <ItemTemplate>
                            <asp:Label ID="PassRemote" runat="server" Text='<%#GetRemote(Eval("Course"))%>'></asp:Label>
                        </ItemTemplate>
  </telerik:GridTemplateColumn>
                           ...
                           <telerik:GridTemplateColumn HeaderText="Lock" AllowSorting="false" AllowFiltering="false">
                        <ItemTemplate>
                            <asp:Label ID="Lock" runat="server" Text='<%#GetLockDown(Eval("MasterProctor_ID"))%>'></asp:Label>
                        </ItemTemplate>
  </telerik:GridTemplateColumn>          



                          <telerik:GridTemplateColumn HeaderText="???" AllowSorting="false" AllowFiltering="false">
                        <ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [MasterProctor_ID], [Course], [FamilyString],[Session],[ExamType], [Reference], [Instructor], [ExamEnd], [ExamStart], [ExamTime], [LPassword], [RPassword], [Lockdown], [Instructions] FROM [MasterProctorTesting] WHERE (([Term] = @Term) AND ([Session] = @Session) AND ([ExamType] = @ExamType)) Order By Course">
                <SelectParameters>
                    <asp:ControlParameter ControlID="lblTerm" DefaultValue="2203" Name="Term" PropertyName="Text" Type="String" />
                    <asp:ControlParameter ControlID="lblSession" DefaultValue="8W1" Name="Session" PropertyName="Text" Type="String" />
                    <asp:ControlParameter ControlID="lblExam" DefaultValue="Final" Name="ExamType" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
            <br />
