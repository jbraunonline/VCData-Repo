...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <telerik:RadGrid ID="RadGrid1" runat="server" DataSourceID="SqlDataSource1" Skin="WebBlue" AllowSorting="True" AllowFilteringByColumn="True">
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
                ...
                <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSource1"  CommandItemDisplay="Top" >
                   ...
                   <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="MidStart" DataType="System.DateTime" FilterControlAltText="Filter MidStart column" HeaderText="MidStart" SortExpression="MidStart" UniqueName="MidStart" >
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="MidEnd" DataType="System.DateTime" FilterControlAltText="Filter MidEnd column" HeaderText="MidEnd" SortExpression="MidEnd" UniqueName="MidEnd">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="FinalStart" DataType="System.DateTime" FilterControlAltText="Filter FinalStart column" HeaderText="FinalStart" SortExpression="FinalStart" UniqueName="FinalStart">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="FinalEnd" DataType="System.DateTime" FilterControlAltText="Filter FinalEnd column" HeaderText="FinalEnd" SortExpression="FinalEnd" UniqueName="FinalEnd">
                        </telerik:GridBoundColumn>
...
<telerik:GridCheckBoxColumn DataField="Signoff" HeaderText="Signoff" SortExpression="Signoff" UniqueName="Signoff" DataType="System.Boolean" FilterControlAltText="Filter Signoff column"></telerik:GridCheckBoxColumn>
                        <telerik:GridCheckBoxColumn DataField="UseDefault" DataType="System.Boolean" FilterControlAltText="Filter UseDefault column" HeaderText="UseDefault" SortExpression="UseDefault" UniqueName="UseDefault">
                        </telerik:GridCheckBoxColumn>
                    </Columns>
                </MasterTableView>
            </telerik:RadGrid>
        </div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [FamilyString], [Parent], [Course], [Outlook], [CanChange], [Session], [IsMidterm], [MidStart], [MidEnd], [MidNameR], [MidTime], [MidPaper], [MidCalculator], [MidGraph], [MidNotes], [IsFinal], [FinalStart], [FinalEnd], [FinalNameL], [FinalTime], [FinalPaper], [FinalCalculator], [FinalGraph], [FinalNotes], [MidProctorX], [FinalProctorX], [MidNameL], [FinalFolderR], [Signoff], [UseDefault] FROM [MasterProctor] WHERE ([Session] = @Session2)">
            <SelectParameters>
                <asp:Parameter DefaultValue="6w1" Name="Session2" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
