<%@ Page Language="vb" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeBehind="8w2MidExmSet_review.aspx.vb" Inherits="VCdata._8w2MidExmSet_review" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <span class="auto-style1"><strong>Review 8W2 MidTerm Proctor Exam Selections</strong></span>
            <telerik:RadGrid ID="RadGrid1" runat="server"  OnItemDataBound="RadGrid1_ItemDataBound" AllowAutomaticUpdates="True" AllowFilteringByColumn="True" AllowSorting="True" AutoGenerateEditColumn="True" DataSourceID="SqlDataSource1" Skin="WebBlue" Height="900px">
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
                ...
                <HeaderStyle Width="40px" />
                        ...
                        <telerik:GridBoundColumn DataField="SignoffDate" DataFormatString="{0:MM/dd/yyyy}" DataType="System.DateTime" HeaderText="SignoffDate" AllowFiltering = "False">

                        </telerik:GridBoundColumn>
                        <telerik:GridCheckBoxColumn DataField="MidProctorX" DataType="System.Boolean" FilterControlAltText="Filter MidProctorX column" HeaderText="MidProctorX" SortExpression="MidProctorX" UniqueName="MidProctorX" AllowFiltering="false" Visible="false">
                        </telerik:GridCheckBoxColumn>
                        <telerik:GridCheckBoxColumn DataField="UseDefault" DataType="System.Boolean" FilterControlAltText="Filter UseDefault column" HeaderText="UseDefault" SortExpression="UseDefault" UniqueName="UseDefault" AllowFiltering="false">
                        </telerik:GridCheckBoxColumn>
