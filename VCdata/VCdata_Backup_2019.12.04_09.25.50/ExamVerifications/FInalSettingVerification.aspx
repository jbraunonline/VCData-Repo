...
&nbsp;
            ...
            </strong></span>&nbsp;<telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True"  OnItemDataBound="RadGrid1_ItemDataBound" AllowSorting="True" AutoGenerateColumns="False" AutoGenerateEditColumn="True" DataSourceID="SqlDataSource1" Height="900px" Skin="WebBlue" Width="2300px" AllowAutomaticUpdates="True">
