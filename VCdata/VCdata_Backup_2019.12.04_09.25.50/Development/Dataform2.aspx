<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Dataform2.aspx.vb" Inherits="VCdata.Dataform2" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table align="left" class="auto-style1">
                <tr>
                    <td>        <telerik:RadDataForm ID="RadDataForm1" runat="server" CssClass="rdfLeftAligned rdfNoFieldHint" DataKeyNames="ID" DataSourceID="SqlDataSource1" RenderMode="Lightweight" Skin="WebBlue">
            <LayoutTemplate>
                <div class="RadDataForm RadDataForm_<%# Container.Skin %> rdfLeftAligned rdfNoFieldHint">
                    ...
                    <div class="rdfPager">
                        <span>
                        <telerik:RadButton ID="btnFirst" runat="server" CommandArgument="First" CommandName="Page" CssClass="rdfActionButton rdfPageFirst" RenderMode="Lightweight" Skin="WebBlue" ToolTip="First">
                            <Icon PrimaryIconCssClass="rdfIcon rdfPageFirstIcon" />
                        </telerik:RadButton>
                        <telerik:RadButton ID="btnPrev" runat="server" CommandArgument="Prev" CommandName="Page" CssClass="rdfActionButton rdfPagePrev" RenderMode="Lightweight" Skin="WebBlue" ToolTip="Previous">
                            <Icon PrimaryIconCssClass="rdfIcon rdfPagePrevIcon" />
                        </telerik:RadButton>
                        </span><span>
                        <telerik:RadButton ID="btnNext" runat="server" CommandArgument="Next" CommandName="Page" CssClass="rdfActionButton rdfPageNext" RenderMode="Lightweight" Skin="WebBlue" ToolTip="Next">
                            <Icon PrimaryIconCssClass="rdfIcon rdfPageNextIcon" />
                        </telerik:RadButton>
                        <telerik:RadButton ID="btnLast" runat="server" CommandArgument="Last" CommandName="Page" CssClass="rdfActionButton rdfPageLast" RenderMode="Lightweight" Skin="WebBlue" ToolTip="Last">
            ...
            <ItemTemplate>
                <fieldset class="rdfFieldset rdfBorders">
                    ...
                    <div class="rdfCommandButtons">
                        <hr class="rdfHr" />
                        <telerik:RadButton ID="InitInsertButton" runat="server" ButtonType="SkinnedButton" CausesValidation="False" CommandName="InitInsert" RenderMode="Lightweight" Skin="WebBlue" Text="Insert" ToolTip="Insert" />
                        <telerik:RadButton ID="EditButton" runat="server" ButtonType="SkinnedButton" CausesValidation="False" CommandName="Edit" RenderMode="Lightweight" Skin="WebBlue" Text="Edit" ToolTip="Edit" />
                        <telerik:RadButton ID="DeleteButton" runat="server" ButtonType="SkinnedButton" CausesValidation="False" CommandName="Delete" RenderMode="Lightweight" Skin="WebBlue" Text="Delete" ToolTip="Delete" />
                    </div>
                </fieldset>
            </ItemTemplate>
            <EditItemTemplate>
                <fieldset class="rdfFieldset rdfBorders">
                    ...
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="FamilyStringTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("FamilyString") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="ParentLabel2" runat="server" AssociatedControlID="ParentTextBox" CssClass="rdfLabel" Text="Parent"></asp:Label>
                        <telerik:RadTextBox ID="ParentTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("Parent") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="CourseLabel2" runat="server" AssociatedControlID="CourseTextBox" CssClass="rdfLabel" Text="Course"></asp:Label>
                        <telerik:RadTextBox ID="CourseTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("Course") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="InstructorTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("Instructor") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="OutlookLabel2" runat="server" AssociatedControlID="OutlookTextBox" CssClass="rdfLabel" Text="Outlook"></asp:Label>
                        <telerik:RadTextBox ID="OutlookTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("Outlook") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="CanChangeLabel2" runat="server" AssociatedControlID="CanChangeCheckBox" CssClass="rdfLabel" Text="CanChange"></asp:Label>
                    ...
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="SessionTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("Session") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="IsMidtermLabel2" runat="server" AssociatedControlID="IsMidtermCheckBox" CssClass="rdfLabel" Text="IsMidterm"></asp:Label>
                    ...
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="MidNameLTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("MidNameL") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="MidFolderLTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("MidFolderL") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="MidNameRLabel2" runat="server" AssociatedControlID="MidNameRTextBox" CssClass="rdfLabel" Text="MidNameR"></asp:Label>
                        <telerik:RadTextBox ID="MidNameRTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("MidNameR") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="MidFolderRTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("MidFolderR") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                    ...
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="MidNotesTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("MidNotes") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="IsFinalLabel2" runat="server" AssociatedControlID="IsFinalCheckBox" CssClass="rdfLabel" Text="IsFinal"></asp:Label>
                    ...
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="FinalNameLTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("FinalNameL") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="FinalFolderLTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("FinalFolderL") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="FinalNameRTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("FinalNameR") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="FinalFolderRTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("FinalFolderR") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                    ...
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="FinalNotesTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("FinalNotes") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="InstCommentsTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("InstComments") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="AccessLabel2" runat="server" AssociatedControlID="AccessCheckBox" CssClass="rdfLabel" Text="Access"></asp:Label>
                    ...
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="VCNotesTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("VCNotes") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="MidProctorXLabel2" runat="server" AssociatedControlID="MidProctorXCheckBox" CssClass="rdfLabel" Text="MidProctorX"></asp:Label>
                    ...
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="MidWindowTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("MidWindow") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="FinalWindowTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("FinalWindow") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="LockdownLabel2" runat="server" AssociatedControlID="LockdownCheckBox" CssClass="rdfLabel" Text="Lockdown"></asp:Label>
                    ...
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="PM_ANXMTRTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("PM_ANXMTR") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        ...
                        <telerik:RadTextBox ID="PF_ANXMTRTextBox" runat="server" RenderMode="Lightweight" Skin="WebBlue" Text='<%# Bind("PF_ANXMTR") %>' WrapperCssClass="rdfInput" />
                    </div>
                    <div class="rdfRow">
                        <asp:Label ID="MidVerifiedLabel2" runat="server" AssociatedControlID="MidVerifiedCheckBox" CssClass="rdfLabel" Text="MidVerified"></asp:Label>
                    ...
                    <div class="rdfCommandButtons">
                        <hr class="rdfHr" />
                        <telerik:RadButton ID="UpdateButton" runat="server" ButtonType="SkinnedButton" CommandName="Update" RenderMode="Lightweight" Skin="WebBlue" Text="Update" ToolTip="Update" />
                        <telerik:RadButton ID="CancelButton" runat="server" ButtonType="SkinnedButton" CausesValidation="False" CommandName="Cancel" RenderMode="Lightweight" Skin="WebBlue" Text="Cancel" ToolTip="Cancel" />
                    </div>
                </fieldset>
            </EditItemTemplate>
            <InsertItemTemplate>
                <fieldset class="rdfFieldset rdfBorders">
                    ...
                    <div class="rdfCommandButtons">
                        <hr class="rdfHr" />
                        <telerik:RadButton ID="PerformInsertButton" runat="server" ButtonType="SkinnedButton" CommandName="PerformInsert" RenderMode="Lightweight" Skin="WebBlue" Text="Insert" ToolTip="Insert" />
                        <telerik:RadButton ID="CancelButton" runat="server" ButtonType="SkinnedButton" CausesValidation="False" CommandName="Cancel" RenderMode="Lightweight" Skin="WebBlue" Text="Cancel" ToolTip="Cancel" />
                    </div>
                </fieldset>
            </InsertItemTemplate>
